...
;;;参数设置
(setq DY0 -150000);;; 附加图与正图最后一张之间距离
(setq DY -88800);;;原图每张竖向间距
(setq DXS 80600);;;每张图长
(setq DYS 57400);;;每张图宽
(setq DXN 90000);;;新图水平间距
(setq DYN 70000);;;新图竖向间距
...
(command "insert" "A1外框" P11 100 "" "")

(setq P12X (+ P11X 90000))
(setq P12Y (+ P11Y 0))
(setq P12 (list P12X P12Y ))
(command "insert" "A1外框" P12 100 "" "")
